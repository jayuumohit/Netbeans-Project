...
<body class="host_version"> 
	...
	<!-- End header -->
		...
		<div class="container text-center">
			<h1>Donation Queries<span class="m_1">********</span></h1>
		</div>
	</div>
        <br><br><br><br><br>
        
       <a class="btn btn-primary" href="adminview.jsp"  id="apply" role="button">BACK</a><br><br>
  ...
  List<Donation> mlist=dao.getdetailsDontation();
if(mlist!=null && !mlist.isEmpty()){
  for( Donation ad:mlist){
      System.out.print("image name show" + ad.getFirstName());
        %>
    
        <tr class="bg-info">
        <th scope="row"><%= ++srno%></th>    
           <td><%= ad.getAmount() %></td><!-- comment -->
