...
<img src="images/Screenshot__22_-removebg-preview.png" alt="" width="100" height="100"<h1> AKSHAR INTERNATIONAL</h1>               
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>NEWSPAPER<span class="m_1"></span></h1>
		</div>
	</div>
        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <p class="lead">"EVERY GOOD CITIZEN ADDS TO THE STRENGTH OF A NATION";</p>
                </div>
            </div><!-- end title -->
            ...
            <div class="row"> 
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="blog-item">
						<div class="image-blog">
							<img src="images/NEW SCHOOL/newspaper1.jpeg" alt="" class="img-fluid">
						</div>
					</div>
                </div><!-- end col -->
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="blog-item">
						<div class="image-blog">
							<img src="images/NEW SCHOOL/newspaper 2.jpeg" alt="" class="img-fluid">
						</div>
					</div>
                </div><!-- end col -->
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="blog-item">
						<div class="image-blog">
							<img src="images/NEW SCHOOL/newspaper 6.jpeg" alt="" class="img-fluid">
						</div>
					</div>
                </div><!-- end col -->
            </div><!-- end row -->
            ...
            <div class="row"> 
                <div class="col-lg-4 col-md-6 col-12">
                   <div class="blog-item">
						<div class="image-blog">
							<img src="images/NEW SCHOOL/newspaper 3.jpeg" alt="" class="img-fluid">
						</div>
					</div>
                </div><!-- end col -->
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="blog-item">
						<div class="image-blog">
							<img src="images/NEW SCHOOL/newspaper4.jpeg" alt="" class="img-fluid">
						</div>
					</div>
                </div><!-- end col -->
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="blog-item">
						<div class="image-blog">
							<img src="images/NEW SCHOOL/newspaper 5.jpeg" alt="" class="img-fluid">
						</div>
					</div>
                </div><!-- end col -->
            </div><!-- end row -->
