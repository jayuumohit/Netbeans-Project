...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>AKSHAT INTERNATIONAL TRUST</title>  
...
<img src="images/Screenshot__22_-removebg-preview.png" alt="" width="100" height="100"<h1> AKSHAT INTERNATIONAL</h1>               
                </a>
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>QUERIES<span class="m_1">********</span></h1>
		</div>
	</div>
...
<div class="cause">
                    <div class="progress cause-progress">
                        ...
                        <h3 class="cause-title"><a href="#">Admission&nbsp;&nbsp; Query</a></h3>
                        <br>

                        <div class="btn-holder text-center">
                  <h3 class="btn btn-primary"><a href="showadmission.jsp">VIEW</a></h3>
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="cause">
                        ...
                        <h3 class="cause-title"><a href="#">Contact&nbsp;&nbsp;Query</a></h3>
                        
<br>
                        <div class="btn-holder text-center">

                  <h3 class="btn btn-primary"><a href="showcontact.jsp">VIEW</a></h3>
                        </div>
                    </div> <!-- /.cause -->
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="cause">
                       ...
                       <h3 class="cause-title"><a href="#">&nbsp;&nbsp;Donation&nbsp;&nbsp;Query</a></h3>
                       
<br>
                        <div class="btn-holder text-center">
                  <h3 class="btn btn-primary"><a href="showdonation.jsp">VIEW</a></h3>
                        </div>
                 ...
                 <div class="col-md-3 col-sm-6">
                    ...
                    <div class="cause">
                       ...
                       <h3 class="cause-title"><a href="#">&nbsp;&nbsp;Notification&nbsp;&nbsp;Alert</a></h3>
                       
<br>
                        <div class="btn-holder text-center">
                  <h3 class="btn btn-primary"><a href="alert1.jsp">Write</a></h3>
                        </div>
