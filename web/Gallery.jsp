...
<body class="host_version"> 
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>Galleries<span class="m_1">*********</span></h1>
		</div>
	</div>
        ...
        <div class="container">
            ...
            <div class="row"> 
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<img src="images/gallery/children's day.jpeg" alt="" class="img-fluid">
						</div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<img src="images/gallery/classes.jpeg" alt="" class="img-fluid">
						</div>
				...
				<div class="col-lg-3 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<img src="images/gallery/Faculties.jpeg" alt="" class="img-fluid">
						</div>
					</div>
                </div><!-- end col -->
				...
				<div class="col-lg-3 col-md-6 col-12">
                   <div class="course-item">
						<div class="image-blog">
							<img src="images/gallery/Republic day.jpeg" alt="" class="img-fluid">
						</div>
					</div>
                </div><!-- end col -->
            </div><!-- end row -->			
            ...
            <div class="row"> 
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<img src="images/gallery/students.jpeg" alt="" class="img-fluid">
						</div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<img src="images/gallery/gallery.jpg" alt="" class="img-fluid">
						</div>
				...
				<div class="col-lg-3 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<img src="images/gallery/Teacher's day.jpeg" alt="" class="img-fluid">
						</div>
					</div>
                </div><!-- end col -->
				...
				<div class="col-lg-3 col-md-6 col-12">
                   <div class="course-item">
						<div class="image-blog">
							<img src="images/gallery/gallery1.jpg" alt="" class="img-fluid">
						</div>
					</div>
                </div><!-- end col -->
            </div><!-- end row -->			
            ...
            <div class="row"> 
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<img src="images/gallery/gallery3.jpg" alt="" class="img-fluid">
						</div>
				...
				<div class="col-lg-3 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<img src="images/gallery/IMG-20230309-WA0005.jpg" alt="" class="img-fluid">
						</div>
