...
<img src="images/Screenshot__22_-removebg-preview.png" alt="" width="100" height="100"<h1> AKSHAR INTERNATIONAL</h1>               
	...
	<!-- End header -->
		...
		<div class="container text-center">
			<h1>FACILITIES<span class="m_1">**********</span></h1>
		</div>
	</div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="pricingTable">
                        <div class="pricingTable-header">
                            ...
                            <span class="price-value">*****<span>?Intelligence plus character ? </span><span>that is the goal of true education ?.</span></span>
                        </div>
                        ...
                        <div class="pricingContent">
                            ...
                            <ul>
                                ...
                                <li>NCERT Syllabus</li>
                                <li>Regular Counselling with Parents</li>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="pricingTable pink">
                        <div class="pricingTable-header">
                            ...
                            <span class="price-value">*****<span> It fuels your learning by stimulating creative thought,</span><span>improving your social and organizational skills ?.</span></span>
                        </div>

                        <div class="pricingContent">
                            <i class="fa fa-briefcase"></i>
                            <ul>
                                <li>Special Library</li>
                                <li>outdoor/indoor sports,projects</li>
                                <li>Self Defence Classes</li>
                                <li>Seminars</li>
                                <li>Workshops</li>
                            </ul>
                        </div><!-- /  CONTENT BOX-->
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="pricingTable orange">
                        <div class="pricingTable-header">
                            ...
                            <span class="price-value">*****<span>?SEEK Safety,AIM Safety,FOLLOW Safety, </span><span>ENSURE Safety,TEACH Safety,YIELD Safety?.</span></span>
                        </div>

                        <div class="pricingContent">
                            <i class="fa fa-cube"></i>
                            <ul>
                                <li>Transport Facilities Available</li>
                                <li>Parents involvement during special classes </li>
                                <li>Interaction b/w parents and faculty</li>
                                <li>Devotional Room</li>
                                <li>Music Room</li>
                            </ul>
                        </div><!-- /  CONTENT BOX-->
