...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>AKSHAT INTERNATIONAL School</title>  
...
<img src="images/Screenshot__22_-removebg-preview.png" alt="" width="100" height="100"<h1> AKSHAT INTERNATIONAL</h1>               
	...
	<!-- End header -->
		...
		<div class="container text-center">
			<h1>Password Recovery<span class="m_1">************</span></h1>
		</div>
	</div>
...
<form role="form" method="post">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <br><br><br><br><br> <h1 class="page-header"><u>Change</u> <u>Password</u></h1>
            <br>
        </div>
        <!-- /.box-header -->
        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-3 col-md-3">
                    <div class="input-group">
                        ...
                        <input class="form-control" id="newPassword" name="username" value="" placeholder="Enter username" type="username">
                    </div>
                </div>
                <!-- /.input group -->
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-3 col-md-3">
                    <h3><label>New Password</label></h3>
                </div>
                <div class="col-xs-12 col-sm-3 col-md-3">
                    <div class="input-group">
                        <div class="input-group-addon">
