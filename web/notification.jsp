...
<html lang="en">
    ...
    <![endif]-->
<style>
        /* CSS for the notification alert message */
        .notification {
            font-family: cursive;
            font-size: 40px;
            color: red;
            cursor: default; /* Set the cursor to default to avoid the text cursor on hover */
        }
        ...
        .notification:hover {
         ...
         .alert:hover {
            border-color: red; /* Change the border color to blue on hover */
            cursor: pointer; /* Change the cursor to a pointer to indicate interactivity */
        }
        ...
        .alert {
            ...
            margin: 10px;
            text-align: center;
            height: auto; /* Set the height to 200 pixels */
        }
    </style>
</head>
<body class="host_version"> 
 <!-- LOADER -->
	...
	<header class="top-navbar">
        ...
        <br>
	&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary" href="index.jsp"  id="apply" role="button">BACK</a><br><br>
        <br>
    

 <center>
        <!-- Add the "notification" class to the <p> tag -->
        <p class="notification"><b>** <u>Notification</u>&nbsp;<u>Alert</u> **</b></p>
    </center>
...
%>
    <div class="alert">
        <strong><b>.&nbsp;&nbsp;.&nbsp;&nbsp;.</b></strong>
        <h1><pre style="font-family: cursive"><%= ad.getMsg() %></pre></h1>
    </div>
<%
    }
  }
