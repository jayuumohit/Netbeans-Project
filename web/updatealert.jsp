...
<img src="images/Screenshot__22_-removebg-preview.png" alt="" width="100" height="100"<h1> AKSHAR INTERNATIONAL</h1>               
	...
	<!-- End header -->
		...
		<div class="container text-center">
			<h1>Update Notification Alert<span class="m_1">*********  *****</span></h1>
		</div>
	</div>
	<head>
        <meta charset="utf-8">
    ...
    <br>
      ...
      <%
          ...
          if(request.getParameter("edit")!=null)
          {
               int id =Integer.parseInt(request.getParameter("edit"));
                  ...
                  NotificationO note = dao.findMessage(id);
             
                message = note.getMsg();
                System.out.println("message-------" + message);
                note_id = note.getNotId();
      ...
      %>
       <fieldset>
        <td>UPDATE MESSAGE HERE:-</td>
        <td><textarea name="msg" type ="text"rows="3"cols="10"><%= message%></textarea></td>
	 </fieldset>
           <%
                                    if(note_id !=0){
                                    %>
                                   
                                      <input type="hidden" class="form-control" name="note_id" value="<%=note_id %>" >
                                    <%
                                    }
                                    %> 
